...
export declare const wsRequestHandler: (handler: (payload: any, sendMessageToClient: ReturnType<typeof createSendMessageToClient>) => Promise<void>, verify?: boolean) => (event: APIGatewayProxyEvent) => Promise<void>;
export {};
